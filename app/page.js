...
export default function Home() {
  return (
    <div className="flex flex-col space-y-8 mt-10">
      <section className="py-24 flex flex-col space-y-3 justify-center overflow-hidden items-center w-full ">
        <div className="bg-accent px-4 py-1 rounded-md shadow-md">
        ...
        <motion.h1
          ...
          className="text-center md:text-6xl text-3xl font-bold tracking-tight md:w-4xl w-3xs text-foreground/65 md:leading-20  capitalize"
        >
